...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "portalenv2s" because\n';
  ...
  $wnd.__gwt_activeModules['portalenv2s'] = {
    'moduleName' : 'portalenv2s',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/portalenv2s.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['portalenv2s'].superdevmode = true;

  var expectedSuffix = '/portalenv2s.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + portalenv2s + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:portalenv2s';
  var devModeSessionKey = '__gwtDevModeSession:portalenv2s';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/portalenv2s/portalenv2s.nocache.js';
  ...
  $wnd.__gwt_activeModules['portalenv2s'].canRedirect = true;
  $wnd.__gwt_activeModules['portalenv2s'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/portalenv2s?user.agent=' + ua + '&_callback=' + callback;
